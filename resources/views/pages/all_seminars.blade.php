...
<body class="bg-gray-100 text-gray-800 text-sm">
    ...
    @foreach($seminars as $seminar)
        <div class="bg-white shadow-md rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300 w-[250px] mx-auto">
            <!-- Smaller passport-style image with fixed height -->
            ...
            <div class="p-3">
                ...
                <ul class="space-y-0.5 text-xs">
                    <li><i class="bi bi-person-fill text-gray-500 mr-1"></i><strong>By:</strong>
